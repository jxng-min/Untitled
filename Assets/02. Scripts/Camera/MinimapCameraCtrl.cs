...
public class MinimapCameraCtrl : MonoBehaviour
{
    ...
    [Header("Player Position's Label")]
    [SerializeField] private TMP_Text m_position_label;
    ...
    public void Update()
    {
        ...
        m_position_label.text = $"x: {m_player_ctrl.transform.position.x}\ny: {m_player_ctrl.transform.position.y}\nz: {m_player_ctrl.transform.position.z}";
